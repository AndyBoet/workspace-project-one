# com-chilipeppr-workspace-project-one
A ChiliPeppr Workspace project-one.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / project-one
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-project-one |
| Name                  | Workspace / project-one |
| Description           | A ChiliPeppr Workspace project-one. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/AndyBoet/workspace-project-one/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/andyboet/workspace-project-one |
| Github URL            | http://github.com/AndyBoet/workspace-project-one |
| Test URL              | https://preview.c9users.io/andyboet/workspace-project-one/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/AndyBoet/workspace-project-one/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-project-one"], // the id you gave your workspace
      function(myWorkspaceProjectOne) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / project-one just got loaded.", myWorkspaceProjectOne);
        myWorkspaceProjectOne.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-project-one"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / project-one"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace project-one."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/AndyBoet/workspace-project-one/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/andyboet/workspace-project-one"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/AndyBoet/workspace-project-one"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-project-one-andyboet.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
