...
cprequire_test(["inline:com-chilipeppr-workspace-project-one"], function(ws) {
    ...
    $('title').html("project-one Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-project-one", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-project-one", // Make the id the same as the cpdefine id
        name: "Workspace / project-one", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace project-one.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a project-one
